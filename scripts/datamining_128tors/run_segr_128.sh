...
TOPO="-topfile $BASE_PATH/topologies/debruijn_N=128_2s_6da.txt"
HOSTS=1024
VLB=""

DATA_PREFIX="$BASE_PATH/data/datamining/128racks_8hosts_10s/ddb-2s-6da-mixed-co$CUTOFF-rto${RTO}ms-cwnd${CWND}-day${DAY}us-night${NIGHT}us-q${QUEUE}-hp1mb-segr-1500/"
mkdir -p "$DATA_PREFIX"
