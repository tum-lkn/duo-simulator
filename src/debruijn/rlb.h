...
class RlbSrc : public EventSource {
 ...
 public:
    RlbSrc(DebruijnTopology* top, NdpLogger* logger, TrafficLogger* pktlogger, EventList &eventlist, int flow_src, int flow_dst);
...
class RlbSink : public EventSource {
    friend class RlbSrc;
 public:
    RlbSink(DebruijnTopology* top, EventList &eventlist, int flow_src, int flow_dst);
