...
int main(int argc, char **argv) {
	...
	tcpSrc = new TcpSrc(NULL,NULL,eventlist, 2, 3);
	tcpSrc->setName("Tcp1"); 
	...
	tcpSrc = new TcpSrc(NULL, NULL, eventlist, 3, 2);
	tcpSrc->setName("Tcp2"); 
    ...
    //MTCP flow 1
    tcpSrc = new TcpSrc(NULL,NULL,eventlist, 1, 0);
    ...
    //MTCP flow 2
    tcpSrc = new TcpSrc(NULL,NULL,eventlist, 0, 1);
