...
typedef enum {IP, TCP, TCPACK, TCPNACK, NDP, NDPACK, NDPNACK, NDPPULL, NDPLITE, NDPLITEACK, NDPLITEPULL, NDPLITERTS,
              ETH_PAUSE, RLB, RLBTCP, RLBTCPACK} packet_type;
...
class Packet {
 ...
 public:
    ...
    int get_real_crthop() {return _real_crt_hop;}
    void inc_crthop() {
        _crthop++;
        _real_crt_hop++;
    }
